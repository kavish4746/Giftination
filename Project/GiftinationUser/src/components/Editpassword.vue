...
<div>
  ...
  <form id="contact">
    ...
    <fieldset>
      <input placeholder="Enter Your Existing Password *" v-model="enteredpassword" type="text" tabindex="1" required autofocus>
      <div class="error-message" id="existingerror" v-show="existingflag"></div>
    </fieldset>
    <fieldset>
      <input placeholder="Enter Your New Password *"  v-model="newpassword" type="text" tabindex="2" required>
    </fieldset>
    <fieldset>
      <button @click="update" type="button" id="contact-submit" data-submit="...Sending">Update Password</button>
...
export default {
  ...
  methods:{
    update:function(){
      ...
      if(this.enteredpassword==doc.data[0].u_password)
      {
        this.infoarr=doc.data;
        this.infoarr[0].u_password=this.newpassword;
      ...
      {
        document.getElementById("existingerror").innerHTML = "Please enter correct Password";
